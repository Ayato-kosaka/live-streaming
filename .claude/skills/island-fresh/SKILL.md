...
**別の名前の付いた料理の絵を、代わりに置かない。材料か、料理の入った器まで。**

| 写っているもの | 例 | |
| --- | --- | --- |
| **材料** | 胡椒のポトフ → 唐辛子／南蛮漬け → 茄子／アクアパッツァ → レモン | **○** |
| **料理の入った器** | パエリア → 具の入った浅鍋 | **○** |
| **別の名前の付いた料理** | アクアパッツァ → サーモンの握り | **✕** |

**食い違いの度合いではなく、種類が違う。** 唐辛子が通るのは**材料**だから。
読む人は「胡椒の効いた鍋なんだな」と読む。握り寿司は材料ではなく
**それ自体が料理の名前**なので、読む人は「**寿司を作った日なんだ**」と読む。
**これは弱いのではなく、嘘。**

図鑑は**あやとが何を作ったかの記録**。空の器は「何も言っていない」だけだが、
別の料理は「**違うことを言っている**」。**記録を汚すほうが、記録が薄いより悪い。**
置ける絵が1枚も無ければ、**空の器のまま残すほうがまだよい。**
