    ...
    <span className="hsign">
      <svg viewBox="0 0 220 74" width="220" height="74" aria-hidden focusable="false">
        ...
        {/* 木目。板と同系の少し濃い色で、細く2本だけ。3本以上入れると汚れて見える。
            字の帯（この viewBox で y 27〜47）には入れない。前は上の1本が y 32 を
            通っていて、そこだけ地が #d38f3a まで沈み、字が 3.57 : 1 になっていた
            （中央値は 5.13 で通るので、地のムラのほうで落ちていた）。 */}
        <path d="M30 25 q40 -3 78 0 q40 3 82 0" className="hsign-grain" />
        <path d="M34 55 q46 4 88 1 q34 -3 66 1" className="hsign-grain" />
        {/* 上端のハイライト。これが無いと板が平らに見える。
            上の木目と重なるので、木目のあとに敷いて艶のほうを上に置く。 */}
        <rect x="22" y="23" width="174" height="6" rx="3" className="hsign-lit" />
        {/* 留めの木ねじ */}
