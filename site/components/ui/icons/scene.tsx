...
export const scene: Record<string, Draw> = {
  ...
  /**
   * 彫刻。リガの通りは、見上げると壁じゅうに顔がある。
   * `museum`（建物）とは別で、**台座に載った像そのもの**を出したいときに使う。
   */
  statue: (c) => (
    <>
      <Sh c={c} cy={57} rx={19} ry={3.6} />
      <path d="M14 48h36l3 8H11z" fill={c.gyd} />
      <rect x="18" y="40" width="28" height="9" rx="2.4" fill={c.gy} />
      {/* 横顔にする。正面の胸像は 16px だと将棋の駒に見えて、像に見えない。
          石なので服の色は持たせず、鼻筋の欠けと明暗2面だけで作る */}
      <path d="M24 26c6 0 11 5 11 11v4H15v-4c0-6 4-11 9-11z" fill={c.cr} />
      <path d="M24 26c6 0 11 5 11 11v4H26z" fill={c.crd} />
      <path d="M22 8c8 0 13 6 13 13 0 3-1 5-3 6l3 3-4 2v3a4 4 0 0 1-4 4h-6c-6 0-12-6-12-14S14 8 22 8z" fill={c.cr} />
      <path d="M22 8c8 0 13 6 13 13 0 3-1 5-3 6l3 3-4 2v3a4 4 0 0 1-4 4h-4V8z" fill={c.crd} />
      <path d="M11 15C13.4 9.6 17.2 7 22 7s8.6 2.6 11 8c-3-2.6-6.6-4-11-4s-8 1.4-11 4z" fill={c.wod} />
      <ellipse cx="19" cy="20" rx="1.5" ry="2" fill={c.ink} opacity={c.flat ? 1 : 0.55} />
