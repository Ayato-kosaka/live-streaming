...
export const misc: Record<string, Draw> = {
  ...
  see: (c) => (
    <>
      <path d="M32 12c14 0 25 8.6 30 20-5 11.4-16 20-30 20S7 43.4 2 32C7 20.6 18 12 32 12z" fill={c.w} />
      <path d="M32 12c14 0 25 8.6 30 20-5 11.4-16 20-30 20z" fill={c.wd} />
      <circle cx="32" cy="32" r="14" fill={c.tl} />
      <circle cx="32" cy="32" r="7.4" fill={c.ink} />
      <circle cx="27.4" cy="27.4" r="3.4" fill={c.w} />
      <Gl c={c} cx={17} cy={22} rx={7} ry={2.6} r={-24} o={0.7} />
    </>
  ),
