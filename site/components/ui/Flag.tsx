...
const FLAGS: Record<string, Spec> = {
  ...
  cyprus: {
    ...
    bg: "#ffffff",
    paths: [
      // 島の形。東へ伸びる尾（カルパス半島）があるかどうかで、あの島だと分かる
      {
        d: `M9.4 7.3c1.6-1.2 4.2-1.6 6.4-1.1 1.4.3 2.4 1 3.6 1 1.1 0 2.2-.5 3.1-.2.9.3.9 1.2.1 1.5-1.2.4-2.2.2-3.2.6-1.3.5-1.6 1.6-3 2-1.9.6-4 .3-5.7-.5-1.6-.8-2.4-2.3-1.3-3.3z`,
        c: "#d57800",
      },
      // オリーブの枝。2本を下で交差させる
      {
        d: `M12.2 12.4c1.4 1.6 3.4 2.4 5.4 2.4M17.8 12.4c-1.4 1.6-3.4 2.4-5.4 2.4`,
        c: "#4e5b31",
      },
    ],
  },
    ...
    if (f.k === "crescent") {
      ...
      return (
        <>
          ...
          {inner}
          <path
            d={`M${cx + W * 0.215} ${H / 2 - 3.2}l.9 2.4 2.5.1-2 1.6.7 2.4-2.1-1.4-2.1 1.4.7-2.4-2-1.6 2.5-.1z`}
            fill={f.fg}
          />
        </>
      );
