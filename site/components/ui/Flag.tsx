...
const FLAGS: Record<string, Spec> = {
  ...
  cyprus: {
    ...
    paths: [
      ...
      // オリーブの枝。2本を下で交差させる。線1本だと枝に見えないので葉を付ける
      {
        d: `M15 15.9c-1.9-.1-3.6-1-4.7-2.5m1.1 0c.5.7 1.3 1 2.1.8m-.6 1.5c.6.5 1.4.7 2.2.5M15 15.9c1.9-.1 3.6-1 4.7-2.5m-1.1 0c-.5.7-1.3 1-2.1.8m.6 1.5c-.6.5-1.4.7-2.2.5`,
        c: "#4e5b31",
      },
    ],
  },
