...
export const CHAPTER_STATS: Record<string, ChapterStat> = {
  ...
  "caucasus": {
    ...
    streams: 444,
    residents: [
      { icon: "1wQzpWPNZKnty7DIiEkrSyib145QIWy4K", days: 278 },
      ...
      { icon: "18okO58dwMaci-9R1go0Rj1dTqliSWlz3", days: 109 },
      { icon: "11ygwplCCuzh5OItBynAVyglM1eZyVUO-", days: 104 },
      { icon: "1bGJUOx4NJU112oix9BwSVrZQJgsakGIq", days: 83 },
      { icon: "1XUYZEts8lz9SFqQmKuBd4G8KMRfBmPL-", days: 70 },
      { icon: "1oRv9hYOkvlbBvDepLcDWEd6CWm19BJkS", days: 63 },
      { icon: "d2ff6294640d4a5aa19bce30dfcbc8840", days: 59 },
      ...
      { icon: "1L3c-p3QtcO5HLqCPUtGisxI-_SpwEaZt", days: 42 },
      ...
      { icon: "1rkhrzVUpkZGXfSpDbyxzOKoHLUZKy8VL", days: 35 },
      ...
      { icon: "1rKI8QR7dLexTBoM8E3LjTCzQCXvzpHlB", days: 18 },
      ...
      { icon: "10hbypXDmWLEcat6gTZz3TuotslN8EiSb", days: 13 },
