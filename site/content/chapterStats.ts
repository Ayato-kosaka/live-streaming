...
export const CHAPTER_STATS: Record<string, ChapterStat> = {
  ...
  "caucasus": {
    ...
    residents: [
      ...
      { icon: "1NLsB-D-jeUxQ3viqwhJu2GkRRXsYXAaQ", days: 241 },
      { icon: "1FQFqrRn7Rx8mTT4KOs36_-H2LHeA4uWz", days: 159 },
      { icon: "1b0Xiz4G4ITGoNeTsNFkzUTXO_xNQd-LU", days: 121 },
      { icon: "18okO58dwMaci-9R1go0Rj1dTqliSWlz3", days: 108 },
      ...
      { icon: "1oRv9hYOkvlbBvDepLcDWEd6CWm19BJkS", days: 62 },
      ...
      { icon: "1L3c-p3QtcO5HLqCPUtGisxI-_SpwEaZt", days: 41 },
      ...
      { icon: "1kzs_Lm8VmHXkfcW3_7LfssXu2P6sDA47", days: 21 },
