...
export const SHORTS: Record<string, Short[]> = {
  ...
  "caucasus": [
    { id: "OCVFgmRss40", date: "2026-02-23", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【カッパドキア編】" },
    { id: "UR8L2JvrmFo", date: "2026-03-13", title: "【AIディズニー】兄弟で世界一周 Part 16 - 食べたいが見つかるグルメアプリと共に。【ハワイ編】" },
  ],
  "iran-walk": [
  ...
  "nordic": [
    { id: "3LFOVakss68", date: "2026-09-15", title: "【三日目】スウェーデンに居る親友に会いに6カ国ヒッチハイク旅します！リトアニア🇱🇹ヴィリニュス" },
  ],
};
