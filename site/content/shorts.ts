...
export const SHORTS: Record<string, Short[]> = {
  ...
  "europe": [
    ...
    { id: "LFxsinVG6a0", date: "2025-02-14", title: "これ18時くらいの出来事だよ？怖すぎた😱😱😱" },
    { id: "hq6beRx4Uss", date: "2025-02-24", title: "黒いタキシードにシルクハット、杖を持つ紳士が紅茶を出してくれる…そんな幻想でイギリスに行くと、まず移民の多さにに驚くでしょう🙃ロンドンの人達も、龍の水墨画を見て日本を誤解しないことを願います😅" },
    { id: "Dxk4lRA1bSc", date: "2025-03-29", title: "ヨーロッパ半年観光したけど、、まだまだだなぁ、、、😫 概要欄も見てね" },
  ],
  "middle-east": [
    { id: "k6cMHwqAfdQ", date: "2025-06-20", title: "旅行計画最強アプリ自分で作ってみた。" },
  ],
  "caucasus": [
    { id: "0BLfzU565sM", date: "2025-07-22", title: "旅行がもっと楽しくなる観光ガイドアプリ作ってみた" },
    { id: "DYA13I3FpnU", date: "2026-02-21", title: "ガキンチョと世界一周！食べたいが見つかるグルメアプリと共に。【モン・サン・ミシェル編】" },
    { id: "XIMN-niotcE", date: "2026-02-21", title: "ガキンチョと世界一周！食べたいが見つかるグルメアプリと共に。【京都編】" },
    { id: "fQmy4q5n6jA", date: "2026-02-21", title: "ガキンチョと世界一周！食べたいが見つかるグルメアプリと共に。【富士山編】" },
    { id: "Own81HH89hI", date: "2026-02-22", title: "ガキンチョと世界一周！食べたいが見つかるグルメアプリと共に。【エジプト編】" },
    { id: "V0e4L1iiPeE", date: "2026-02-22", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【サントリーニ島編】" },
    { id: "NzHVWEODSp4", date: "2026-02-23", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【ディズニーランド編】" },
    { id: "OCVFgmRss40", date: "2026-02-23", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【カッパドキア編】" },
    { id: "js6TTabvufo", date: "2026-02-24", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【ロコモコ編】" },
    { id: "I_WfcLyGf2c", date: "2026-02-25", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【ヴェネツィアのゴンドラ編】" },
    { id: "EyvGwAow8BI", date: "2026-02-26", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【パリでクレープ編】" },
    { id: "YcYedJSjhCE", date: "2026-03-02", title: "兄弟で世界一周！食べたいが見つかるグルメアプリと共に。【雨のロンドン編】" },
    { id: "23xoC-tg3P4", date: "2026-03-04", title: "兄弟で世界一周 Part 12 - 食べたいが見つかるグルメアプリと共に。【パリ・コンコルド広場編】" },
    { id: "u0ewu27weD8", date: "2026-03-06", title: "兄弟で世界一周 Part 13 - 食べたいが見つかるグルメアプリと共に。【ニューヨーク編】" },
    { id: "ROpndI_iQUY", date: "2026-03-11", title: "【AIディズニー】兄弟で世界一周 Part 14 - 食べたいが見つかるグルメアプリと共に。【フィレンツェ編】" },
    { id: "UR8L2JvrmFo", date: "2026-03-13", title: "【AIディズニー】兄弟で世界一周 Part 16 - 食べたいが見つかるグルメアプリと共に。【ハワイ編】" },
    { id: "nvLNg5nbouk", date: "2026-03-13", title: "【AIディズニー】兄弟で世界一周 Part 15 - 食べたいが見つかるグルメアプリと共に。【ドバイ編】" },
    { id: "W4grVjo_65k", date: "2026-03-14", title: "【AIディズニー】兄弟で世界一周 Part 17 - 食べたいが見つかるグルメアプリと共に。【韓国編】" },
  ],
  "iran-walk": [
  ...
  "nordic": [
    { id: "W3aJzjav7fk", date: "2026-09-13", title: "🇸🇪スウェーデンに居る親友に会いに6カ国ヒッチハイク旅します！海外のサービスエリアに取り残された、1日目レッツゴー！" },
    { id: "pHTAZeclZnQ", date: "2026-09-13", title: "【二日目】スウェーデンに居る親友に会いに6カ国ヒッチハイク旅します！ポーランドビャウィストク" },
    { id: "3LFOVakss68", date: "2026-09-15", title: "【三日目】スウェーデンに居る親友に会いに6カ国ヒッチハイク旅します！リトアニア🇱🇹ヴィリニュス" },
    { id: "7kdy1Mwh3ms", date: "2026-09-17", title: "【五日目】スウェーデンに居る親友に会いに6カ国ヒッチハイク旅します！ラトビア🇱🇻リガ" },
  ],
};
