...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    kind: "rice",
    date: "2026-08-28",
    note: "1回の配信で3品つくった日の1品目。炊飯器の水加減が多めで、やわらかめに炊き上がった。",
    streams: [{ label: "調理", date: "2026-08-28", videoId: "YjiWI5reVCo", title: "ジョージアで炊き込みご飯、茶碗蒸し、ポトフ作ります" }],
  },
  {
    slug: "chawanmushi",
    name: "茶碗蒸し",
    ...
    kind: "side",
    date: "2026-08-28",
    note: "だしの代わりにカップラーメンのスープで作った。ちゃんと固まった。",
    streams: [{ label: "調理", date: "2026-08-28", videoId: "YjiWI5reVCo", title: "ジョージアで炊き込みご飯、茶碗蒸し、ポトフ作ります" }],
  },
  {
    slug: "pot-au-feu",
    ...
    kind: "soup",
    date: "2026-08-28",
    note: "3品目。傷みかけたじゃがいもを入れるかどうかでチャットが割れた。キャベツは手でちぎって鍋へ。",
    streams: [{ label: "調理", date: "2026-08-28", videoId: "YjiWI5reVCo", title: "ジョージアで炊き込みご飯、茶碗蒸し、ポトフ作ります" }],
  },
  {
    slug: "oshinko",
    ...
    kind: "side",
    date: "2026-09-03",
    note: "きゅうりとキャベツの塩漬け。翌日のチキンカツのために、かたいパンから生パン粉も作った。",
    streams: [{ label: "調理", date: "2026-09-03", videoId: "5-1bHix5X1s", title: "おしんこつくろかーー！！" }],
  },
  {
    slug: "chicken-katsu-don",
    name: "チキンカツとじ丼",
    emoji: "🥩",
    icon: "food-frikandel-speciaal",
    country: "georgia",
    kind: "rice",
    date: "2026-09-04",
