...
export type StreamType = {
  ...
  /**
   * 流れの見出し。
   * 5つの型を同じ「この日は、こういう順で進む」で始めると、紙の作りも同じなので
   * 5面が同じページに見える。型ごとに、来た人の頭の中にある問いを置く
   * （`docs/island-design.md` 5章）。
   */
  flow: string;
  /** その型の代表的な配信 */
