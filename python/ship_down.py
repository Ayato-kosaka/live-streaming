...
class Gh(run_watch.Gh):
    ...
    # 待ちの札（`待ち-あやと` fbca04 / `待ち-システム` 0e8a16 / `旅のあと` 1d76db）が
    ...
    # 既定が `待ち-システム` なのは、**分からないときに人を呼ばない**ため
    WAIT = WAIT_US
    STYLE = WAIT_STYLE
